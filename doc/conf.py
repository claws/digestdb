...
init_file = os.path.join(
    os.path.dirname(os.path.dirname(__file__)), 'digestdb', '__init__.py')
...
# documentation.
html_theme_options = {
    'description': 'Digestdb provides SQL style access to binary data files'
...
html_title = "DigestDB Documentation"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "DigestDB"
